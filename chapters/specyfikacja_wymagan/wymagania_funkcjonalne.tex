...
\funcreq{
	...
	Nazwa zabiegu, cena i~wymagane sprzęty (opcjonalne).
}{
	Użytkownik
}{
...
\funcreq{
	...
	System umożliwia przeglądanie oraz filtorwanie zabiegów po nazwie, cenie, nazwie sprzętu, imieniu i~nazwisku lekarza.
}{
	System musi umożliwiać przeglądanie dostępnych w~bazie danych zabiegów.
}{
	Użytkownik jest zalogowany do panelu administracyjnego.
}{
	Nazwa zabiegu (opcjonalne), cena (opcjonalne), nazwa sprzętu (opcjonlane), imie i~naziwsko lekarza.
}{
	Użytkownik
}{
...
\funcreq{
	...
	System ma umożliwić zmianę błędnej nazwy, ceny lub powiązanego sprzętu.
}{
	Użytkownik jest zalogowany do panelu administracyjnego.\\
	Nie może być dwóch zabiegów o~tej samej nazwie.
}{
